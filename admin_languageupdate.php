<?php
/* ************************************************************************
' admin_languageupdate.php -- Update a language
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="name" maxlength="50" style="width: 200px;" value="<?php echo $language->name; ?>" /></div>
