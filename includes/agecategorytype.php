<?php
class AgeCategoryType extends DatabaseObject {

	protected static $tablename = 'agecategorytypes';
	protected static $classname = 'AgeCategoryType';
