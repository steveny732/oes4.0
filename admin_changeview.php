<?php
/* ************************************************************************
' admin_changeview.php -- Administration - Show details of a change request
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Change/Transfer/Offer Enquiry</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_changelist.php">change/transfer/offer list</a>&nbsp;&gt;&nbsp;
						change/transfer/offer enquiry<br /><br /><br />
					</div>
					<div class="clear"></div>
					<table width="100%" cellpadding="2" cellspacing="0">
						...
						<tr class="whitebg">
							<td>Name:</td>
							<td><strong><?php echo $transfer->oldfirstname. " ". $transfer->oldsurname; ?></strong></td>
							<td><strong><?php echo $transfer->newfirstname. " ". $transfer->newsurname; ?></strong></td>
						</tr>
						<tr class="greybg">
							<td>Address 1:</td>
