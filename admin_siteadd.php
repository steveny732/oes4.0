<?php
/* ************************************************************************
' admin_siteadd.php -- Administration - Add a site
'
...
'	Version: 1.0
'	Last Modified By:
'		betap 2008-07-21 20:57:43
'		Add image urls and colours.
'		betap 2008-07-10 21:58:04
	...
	<head>
		...
		<script type="text/javascript">
			function checkme() {
				...
				if (document.form1.currencycode.value == "") {
					missinginfo += "\nYou must select a currency code";
				}
				if (document.form1.languagecode.value == "") {
					missinginfo += "\nYou must select a language code";
				}
				...
				} else if (document.form1.smtpserver.value.toUpperCase() == "*NONE") {
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form method="post" name="form1" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="title" maxlength="50" style="width: 200px;" /></div>
						<div class="clear"></div><br />
						...
						<div class="formfield"><input type="text" name="securesiteurl" maxlength="200" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">Google Analytics ID:</div>
						<div class="formfield"><input type="text" name="googleanalyticscode" maxlength="200" style="width: 200px;" /></div>
						<div class="clear"></div><br />
						...
						<div class="formfield"><input type="text" name="bannerimgurl" maxlength="200" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">Club Image:</div>
						<div class="formfield"><input type="text" name="clubimgurl" maxlength="200" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">News Image:</div>
						<div class="formfield"><input type="text" name="newsimgurl" maxlength="200" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">Menu Colour:</div>
						<div class="formfield"><input type="text" name="menucolour" id="colour1" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour1">choose colour</a></div>
						<div class="clear"></div>
						<div class="formcaption">Menu Text Colour:</div>
						<div class="formfield"><input type="text" name="menutextcolour" id="colour2" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour2">choose colour</a>&nbsp;
							<span id="demo1" style="display: inline-block; width: 200px; background-color: <?php if (empty($currentSite->menucolour)) { echo "#FF9933"; } else { echo $currentSite->menucolour; } ?>; color: <?php if (empty($currentSite->menutextcolour)) { echo "#000000"; } else { echo $currentSite->menutextcolour; } ?>;">&nbsp;Example Menu Item</span></div>
						<div class="clear"></div>
						<div class="formcaption">Menu Rollover Colour:</div>
						<div class="formfield"><input type="text" name="menurocolour" id="colour3" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour3">choose colour</a></div>
						<div class="clear"></div>
						<div class="formcaption">Menu Text Rollover Colour:</div>
						<div class="formfield"><input type="text" name="menutextrocolour" id="colour4" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour4">choose colour</a>&nbsp;
							<span id="demo2" style="display: inline-block; width: 200px; background-color: <?php if (empty($currentSite->menurocolour)) { echo "#FFB953"; } else { echo $currentSite->menurocolour; } ?>; color: <?php if (empty($currentSite->menutextrocolour)) { echo "#000000"; } else { echo $currentSite->menutextrocolour; } ?>;">&nbsp;Example Menu Item Rollover</span></div>
						<div class="clear"></div>
						<div class="formcaption">Button Colour:</div>
						<div class="formfield"><input type="text" name="buttoncolour" id="colour5" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour5">choose colour</a></div>
						<div class="clear"></div>
						<div class="formcaption">Button Text Colour:</div>
						<div class="formfield"><input type="text" name="buttontextcolour" id="colour6" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour6">choose colour</a>&nbsp;
							<span id="demo3" style="display: inline-block; width: 200px; background-color: <?php if (empty($currentSite->buttoncolour)) { echo "#FF9933"; } else { echo $currentSite->buttoncolour; } ?>; color: <?php if (empty($currentSite->buttontextcolour)) { echo "#000000"; } else { echo $currentSite->buttontextcolour; } ?>;">&nbsp;Example Button</span></div>
						<div class="clear"></div>
						<div class="formcaption">Button Rollover Colour:</div>
						<div class="formfield"><input type="text" name="buttonrocolour" id="colour7" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour7">choose colour</a></div>
						<div class="clear"></div>
						<div class="formcaption">Button Text Rollover Colour:</div>
						<div class="formfield"><input type="text" name="buttontextrocolour" id="colour8" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour8">choose colour</a>&nbsp;
							<span id="demo4" style="display: inline-block; width: 200px; background-color: <?php if (empty($currentSite->buttonrocolour)) { echo "#FFB953"; } else { echo $currentSite->buttonrocolour; } ?>; color: <?php if (empty($currentSite->buttontextrocolour)) { echo "#000000"; } else { echo $currentSite->buttontextrocolour; } ?>;">&nbsp;Example Button Rollover</span></div>
						<div class="clear"></div>
						<div class="formcaption">Heading Colour:</div>
						<div class="formfield"><input type="text" name="headingcolour" id="colour9" maxlength="7" style="width: 50px;" />&nbsp;<a href="#" id="pickcolour9">choose colour</a></div>
						<div class="clear"></div><br />
						<div class="formcaption">Sender Email:</div>
						<div class="formfield"><input type="text" name="emailfrom" maxlength="100" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">Entry BCC:</div>
						<div class="formfield"><input type="text" name="entrybcc" maxlength="100" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">SMTP Server:</div>
						<div class="formfield"><input type="text" name="smtpserver" maxlength="50" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">SMTP Username:</div>
						<div class="formfield"><input type="text" name="smtpusername" maxlength="50" style="width: 200px;" /></div>
						<div class="clear"></div>
						<div class="formcaption">SMTP Password:</div>
						<div class="formfield"><input type="password" name="smtppassword" maxlength="50" style="width: 200px;" /></div>
						<div class="clear"></div><br />
						<div class="formcaption">Copyright:</div>
						<div class="formfield"><input type="text" name="copyright" maxlength="50" style="width: 200px;" /></div>
						<div class="clear"></div><br />
						<div class="formcaption">Log Payments?:</div>
						<div class="formfield"><input type="checkbox" name="paylogactive" /></div>
						<div class="clear"></div>
						<div class="formcaption">Down for Maintenance?:</div>
						<div class="formfield"><input type="checkbox" name="downformaint" /></div>
