<?php
/* ************************************************************************
' admin_pagedelete.php -- Administration - Confirm and delete a page
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<div class="floatright" style="text-align: right;">
						...
						delete page<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following page?<br /><br />
					<div class="formcaption">Page Name:</div>
					<div class="formfield"><strong><?php echo $page->name; ?></strong></div>
