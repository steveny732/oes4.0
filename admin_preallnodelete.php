<?php
/* ************************************************************************
' admin_preallnodelete.php -- Administration - Delete a pre-allocation
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Preallocation</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_racelist.php">race list</a>&nbsp;&gt;&nbsp;
						<a href="admin_preallnolist.php">preallocation list</a>&nbsp;&gt;&nbsp;
						delete preallocation<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following preallocation?<br /><br />
					<div class="formcaption">Race Number:</div>
					<div class="formfield"><strong><?php echo $preallno->racenumber; ?></strong></div>
