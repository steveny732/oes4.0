<?php
/* ************************************************************************
' admin_contentupdate.php -- Administration - Update a Page Content Block
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="sequence" size="10" value="<?php echo $content->sequence; ?>" /></div>
						<div class="clear"></div>
						<div class="formcaption">Type:</div>
						<div class="formfield">
							<select name="type" onchange="toggleText();">
								<option value="text"<?php if ($content->type == 'text') { echo ' selected="selected"'; } ?>>Formatted Text</option>
								<option value="plaintext"<?php if ($content->type == 'plaintext') { echo ' selected="selected"'; } ?>>Plain Text</option>
								<option value="raceentry"<?php if ($content->type == 'raceentry') { echo ' selected="selected"'; } ?>>Race Entry</option>
								<option value="news"<?php if ($content->type == 'news') { echo ' selected="selected"'; } ?>>News</option>
								<option value="contact"<?php if ($content->type == 'contact') { echo ' selected="selected"'; } ?>>Contact</option>
								<option value="contactemail"<?php if ($content->type == 'contactemail') { echo ' selected="selected"'; } ?>>Contact Email</option>
							</select>
						</div>
						<div class="clear"></div><br />
						...
						<div id="textplain" style="display: none;">
							...
							<div class="formfield"><input name="plaintext" size="70" value="<?php echo $content->text; ?>" /></div><br /><br />
						</div>
						<div class="clear"></div><br />
