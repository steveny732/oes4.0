<?php
/* ************************************************************************
' admin_racepriceadd.php -- Administration - Add a race price
'
...
if (!empty($_POST['submit'])) {
	...
	if (RacePrice::checkForOverlappingPrices(0, $_SESSION['raceid'], $p_startdate, $p_enddate)) {
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Add Race Price</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_racelist.php">race list</a>&nbsp;&gt;&nbsp;
						<a href="admin_racepricelist.php">race price list</a>&nbsp;&gt;&nbsp;
						add race price<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					<form method="post" name="form1" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						<div class="formcaption">Name:</div>
						<div class="formfield"><input type="text" name="name" id="name" style="width: 200px;" dojoType="dijit.form.ValidationTextBox" propercase="true" required="true" invalidMessage="Name must be entered" value="<?php if (isset($params['name'])) echo $params['name']; ?>" /></div>&nbsp;<?php echo '<span class="stylered">'. $p_errorMessage. '</span>'; ?>
						<div class="clear"></div>
						<div class="formcaption">From Date:</div>
						<div class="formfield"><input type="text" name="startdate" id="startdate" style="width: 100px;" dojoType="dijit.form.DateTextBox" required="true" value="<?php if (isset($params['startdate'])) echo $params['startdate']; ?>" /></div>
						<div class="clear"></div>
						<div class="formcaption">To Date:</div>
						<div class="formfield"><input type="text" name="enddate" id="enddate" style="width: 100px;" dojoType="dijit.form.DateTextBox" required="true" value="<?php if (isset($params['enddate'])) echo $params['enddate']; ?>" /></div>
						<div class="clear"></div>
						<div class="formcaption">Race Fee:</div>
						<div class="formfield"><input type="text" name="fee" id="fee" style="width: 100px;" dojoType="dijit.form.CurrencyTextBox" required="true" value="<?php if (isset($params['fee'])) echo $params['fee']; ?>" /></div>
            <div class="clear"></div>
						<div class="formcaption">Online Fee:</div>
						<div class="formfield"><input type="text" name="onlinefee" id="onlinefee" style="width: 100px;" dojoType="dijit.form.CurrencyTextBox" required="true" value="<?php if (isset($params['onlinefee'])) echo $params['onlinefee']; ?>" /></div>
