<?php
/* ************************************************************************
' admin_dbcolumndelete.php -- Administration - Delete Database Column
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Database Column</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_dbgrouplist.php">database group list</a>&nbsp;&gt;&nbsp;
						<a href="admin_dbcolumnlist.php">database column list</a>&nbsp;&gt;&nbsp;
						delete database column<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following database column?<br /><br />
					<div class="formcaption">Name:</div>
					<div class="formfield"><strong><?php echo $dbcolumn->name; ?></strong></div>
					<div class="clear"></div><br />
					<div class="formcaption">Description:</div>
					<div class="formfield"><?php echo $dbcolumn->description; ?></div>
