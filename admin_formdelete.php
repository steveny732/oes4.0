<?php
/* ************************************************************************
' admin_formdelete.php -- Administration - Confirm and Delete a Form
'
...
if (!empty($_POST['submit'])) {
	...
	FormLang::deleteAllForForm($form->id);
	FormField::deleteAllForForm($form->id);
	FormFieldLang::deleteAllOrphaned();
	$form->delete();
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<div class="floatright" style="text-align: right;">
						...
						delete form<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following form?<br /><br />
					<div class="formcaption">Form Name:</div>
					<div class="formfield"><strong><?php echo $form->name; ?></strong></div>
