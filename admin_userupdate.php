<?php
/* ************************************************************************
' admin_userupdate.php -- Administration - Update a user
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onSubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><?php echo $user->name; ?></div>
						<div class="clear"></div><br />
					 ...
					 <option value="<?php echo $level->id; ?>"<?php if ($user->levelid == $level->id) { echo ' selected="selected"'; } ?>><?php echo $level->name; ?></option>
								<?php
								} ?>
							</select>
						</div>
