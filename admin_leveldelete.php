<?php
/* ************************************************************************
' admin_leveldelete.php -- Confirm and delete a security level
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Security Level</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_levellist.php">security level list</a>&nbsp;&gt;&nbsp;
						delete security level<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following security level?<br /><br />
					<div class="formcaption">Level Name:</div>
					<div class="formfield"><strong><?php echo $level->name; ?></strong></div>
