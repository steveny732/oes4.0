<?php
/* ************************************************************************
' admin_userdelete.php -- Administration - Confirm and delete a user
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<div class="floatright" style="text-align: right;">
						...
						delete user<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following user?<br /><br />
					<div class="formcaption">User Name:</div>
					<div class="formfield"><strong><?php echo $user->name; ?></strong></div>
