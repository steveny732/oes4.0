<?php
/* ************************************************************************
' news_detail.php -- Race news item detail page
'
		...
		<div id="pagecontainer">
			<div id="windowcontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<?php
						echo '<h3>'. $newsitem->headline. '</h3>'; ?>
					</div>
					<div class="floatright">
						<a href="#" onclick="window.close();" style="color:#000000; text-decoration:none"><?php echo $content->text; ?>&nbsp;<img src="images/close_icon.gif" width="8" height="8" alt="<?php if (empty($content->text)) { echo $content->summary; } else { echo $content->text; } ?>" /></a>
					</div>
					<div class="clear"></div><br />
					<div class="floatleft"><?php echo $newsitem->text; ?></div>
