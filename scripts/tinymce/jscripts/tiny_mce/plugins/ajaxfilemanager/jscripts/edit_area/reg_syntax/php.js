editAreaLoader.load_syntax["php"] = {
	...
	,'KEYWORDS' : {
		...
		,'functions' : [
			...
			'session_start', 'session_destroy', 'session_unset', 'session_set_save_handler', 'session_cache_limiter', 'session_cache_expire', 'session_set_cookie_params', 'session_get_cookie_params', 'session_write_close', 'preg_match', 'preg_match_all', 'preg_replace', 'preg_replace_callback', 'preg_split', 'preg_quote', 'preg_grep', 'overload', 'ctype_alnum', 'ctype_alpha', 'ctype_cntrl', 'ctype_digit', 'ctype_lower', 'ctype_graph', 'ctype_print', 'ctype_punct', 'ctype_space', 'ctype_upper', 'ctype_xdigit', 'virtual', 'apache_request_headers', 'apache_note', 'apache_lookup_uri', 'apache_child_terminate', 'apache_setenv', 'apache_response_headers', 'apache_get_version', 'getallheaders', 'pdo_connect', 'pdo_pconnect', 'pdo_close', 'pdo_select_db', 'pdo_create_db', 'pdo_drop_db', 'pdo_query', 'pdo_unbuffered_query', 'pdo_db_query', 'pdo_list_dbs', 'pdo_list_tables', 'pdo_list_fields', 'pdo_list_processes', 'pdo_error', 'pdo_errno', 'pdo_affected_rows', 'pdo_insert_id', 'pdo_result', 'pdo_num_rows', 'pdo_num_fields', 'pdo_fetch_row', 'pdo_fetch_array', 'pdo_fetch_assoc', 'pdo_fetch_object', 'pdo_data_seek', 'pdo_fetch_lengths', 'pdo_fetch_field', 'pdo_field_seek', 'pdo_free_result', 'pdo_field_name', 'pdo_field_table', 'pdo_field_len', 'pdo_field_type', 'pdo_field_flags', 'pdo_escape_string', 'pdo_real_escape_string', 'pdo_stat',
			'pdo_thread_id', 'pdo_client_encoding', 'pdo_get_client_info', 'pdo_get_host_info', 'pdo_get_proto_info', 'pdo_get_server_info', 'pdo_info', 'mysql', 'pdo_fieldname', 'pdo_fieldtable', 'pdo_fieldlen', 'pdo_fieldtype', 'pdo_fieldflags', 'pdo_selectdb', 'pdo_createdb', 'pdo_dropdb', 'pdo_freeresult', 'pdo_numfields', 'pdo_numrows', 'pdo_listdbs', 'pdo_listtables', 'pdo_listfields', 'pdo_db_name', 'pdo_dbname', 'pdo_tablename', 'pdo_table_name', 'pg_connect', 'pg_pconnect', 'pg_close', 'pg_connection_status', 'pg_connection_busy', 'pg_connection_reset', 'pg_host', 'pg_dbname', 'pg_port', 'pg_tty', 'pg_options', 'pg_ping', 'pg_query', 'pg_send_query', 'pg_cancel_query', 'pg_fetch_result', 'pg_fetch_row', 'pg_fetch_assoc', 'pg_fetch_array', 'pg_fetch_object', 'pg_fetch_all', 'pg_affected_rows', 'pg_get_result', 'pg_result_seek', 'pg_result_status', 'pg_free_result', 'pg_last_oid', 'pg_num_rows', 'pg_num_fields', 'pg_field_name', 'pg_field_num', 'pg_field_size', 'pg_field_type', 'pg_field_prtlen', 'pg_field_is_null', 'pg_get_notify', 'pg_get_pid', 'pg_result_error', 'pg_last_error', 'pg_last_notice', 'pg_put_line', 'pg_end_copy', 'pg_copy_to', 'pg_copy_from',
