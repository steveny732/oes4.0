<?php
/* ************************************************************************
' admin_languagedelete.php -- Confirm and delete a language
'
...
$language = Language::findById($_REQUEST['id']);
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Language/Locale</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_languagelist.php">language/locale list</a>&nbsp;&gt;&nbsp;
						delete language/locale<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following language/locale?<br /><br />
					<div class="formcaption">Language/Locale Name:</div>
					<div class="formfield"><strong><?php echo $language->name; ?></strong></div>
