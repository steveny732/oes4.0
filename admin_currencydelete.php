<?php
/* ************************************************************************
' admin_currencydelete.php -- Confirm and delete a currency
'
...
$currency = Currency::findById($_REQUEST['id']);
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<div class="floatright" style="text-align: right;">
						...
						delete currency<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following currency?<br /><br />
					<div class="formcaption">Currency Name:</div>
					<div class="formfield"><strong><?php echo $currency->name; ?></strong></div>
