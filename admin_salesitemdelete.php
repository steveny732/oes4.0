<?php
/* ************************************************************************
' admin_salesitemdelete.php -- Confirm and delete a sales item
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Sales Item</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_salesitemlist.php">sales item list</a>&nbsp;&gt;&nbsp;
						delete sales item<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following sales item?<br /><br />
					<div class="formcaption">Sales Item Name:</div>
					<div class="formfield"><strong><?php echo $salesitem->name; ?></strong></div>
