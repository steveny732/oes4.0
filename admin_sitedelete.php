<?php
/* ************************************************************************
' admin_sitedelete.php -- Administration - Confirm and delete a site
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<div class="floatright" style="text-align: right;">
						...
						delete site<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following site?<br /><br />
					<div class="formcaption">Site Title:</div>
					<div class="formfield"><strong><?php echo $site->title; ?></strong></div>
