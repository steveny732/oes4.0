<?php
/* ************************************************************************
' admin_clubtypeupdate.php -- Administration - Update a Club Type
'
		...
		<script type="text/javascript">
			function checkme() {
				...
				if (document.form1.name.value == "") {
					missinginfo += "\nYou must enter a club type name";
				}
				if (missinginfo != "") {
					alert(missinginfo);
					return false;
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="name" maxlength="50" style="width: 200px;" value="<?php echo $clubtype->name; ?>" /></div>
