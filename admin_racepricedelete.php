<?php
/* ************************************************************************
' admin_racepricedelete.php -- Administration - Delete a race price
'
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Race Price</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_racelist.php">race list</a>&nbsp;&gt;&nbsp;
						<a href="admin_racepricelist.php">race price list</a>&nbsp;&gt;&nbsp;
						delete race price<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following race price?<br /><br />
					<div class="formcaption">Name:</div>
					<div class="formfield"><strong><?php echo $raceprice->name; ?></strong></div>
