<?php
/* ************************************************************************
' admin_levelupdate.php -- Update a security level
'
...
$level = Level::findById($_REQUEST['id']);
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onSubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="name" maxlength="50" style="width: 200px;" value="<?php echo $level->name; ?>" /></div>
						<div class="clear"></div>
						<div class="formcaption">Level Number:</div>
						<div class="formfield"><input type="text" name="number" style="width: 50px;" value="<?php echo $level->number; ?>" /></div>
