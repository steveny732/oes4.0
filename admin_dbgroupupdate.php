<?php
/* ************************************************************************
' admin_dbgroupupdate.php -- Update a Database Group
'
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form name="form1" method="post" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="name" maxlength="50" style="width: 200px;" value="<?php echo $dbgroup->name; ?>" /></div>
