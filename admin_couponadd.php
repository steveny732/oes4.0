<?php
/* ************************************************************************
' admin_couponadd.php -- Administration - Add a coupon
'
...
if (!empty($_POST['submit'])) {
	...
	$chkcoupon = Coupon::findByRaceAndCouponCode($_SESSION['raceid'], $_POST['code']);
	if (!empty($chkcoupon)) {
			...
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					...
					<form method="post" name="form1" onsubmit="return checkme();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						...
						<div class="formfield"><input type="text" name="code" id="code" style="width: 50px;" dojoType="dijit.form.ValidationTextBox" required="true" uppercase="true" invalidMessage="Code must be entered" value="<?php if (isset($params['code'])) echo $params['code']; ?>" /></div>&nbsp;<?php echo '<span class="stylered">'. $p_errorMessage. '</span>'; ?>
						<div class="clear"></div>
						<div class="formcaption">Name:</div>
						<div class="formfield"><input type="text" name="name" id="name" style="width: 200px;" dojoType="dijit.form.ValidationTextBox" propercase="true" required="true" invalidMessage="Name must be entered" value="<?php if (isset($params['name'])) echo $params['name']; ?>" /></div>
						<div class="clear"></div>
						...
						<div class="formfield"><input type="text" name="discount" id="discount" style="width: 100px;" dojoType="dijit.form.CurrencyTextBox" required="true" value="<?php if (isset($params['discount'])) echo $params['discount']; ?>" /></div>
