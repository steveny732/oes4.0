<?php
/* ************************************************************************
' admin_agecategorytypedelete.php -- Administration - Confirm and Delete an Age Category Type
'
...
if (!empty($_POST['submit'])) {
	...
	AgeCategory::deleteAll($agecategorytype->id);
	$agecategorytype->delete();
		...
		<div id="pagecontainer">
			<div id="maincontainer">
				<div class="windowcontentcolumn0">
					<div class="floatleft">
						<h2>Delete Age Category Type</h2>
					</div>
					<div class="floatright" style="text-align: right;">
						<a href="admin_loggedin.php">admin menu</a>&nbsp;&gt;&nbsp;
						<a href="admin_agecategorytypelist.php">age category type list</a>&nbsp;&gt;&nbsp;
						delete age category type<br /><br /><br />
					</div>
					<div class="clear"></div><br />
					Are you absolutely sure you want to delete the following age category type?<br /><br />
					<div class="formcaption">Age Category Type Name:</div>
					<div class="formfield"><strong><?php echo $agecategorytype->name; ?></strong></div>
